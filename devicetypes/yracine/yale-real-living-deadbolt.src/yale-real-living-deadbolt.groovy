metadata {
	...
	definition (name: "Yale Real Living Deadbolt", namespace: "yracine", author: "Clark Tomlinson") {
		capability "Actuator"
		capability "Lock"
		capability "Polling"
		capability "Refresh"
...
/*		Custom attributes and command till stock code management is complete
*/
	...
	tiles {
		...
		main "toggle"
		details(["toggle", "lock", "unlock", "battery",  "usercode", "refresh"])
	}
}
